...
export default function NewAnalysis() {
  ...
  const mutation = useMutation<
    AnalysisResult,
    Error,
    { transcript: string; category?: string; protocolo?: string }
  >({
      ...
      <div className="max-w-4xl mx-auto space-y-8 pb-12">
        <div>
          ...
          <p className="text-muted-foreground">
            Cole o transcrito do atendimento para avaliar empatia, clareza e
            resolutividade.
          </p>
        </div>
              ...
              <Card className="border-primary/20 shadow-[0_0_30px_-10px_rgba(229,9,20,0.1)]">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground/60">
                      Informe o número do protocolo da conversa para
                      identificação no histórico.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="category"
                      placeholder="Ex: Suporte Técnico, Vendas, Retenção"
                      value={category}
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="transcript"
                      placeholder={
                        "[Operador]: Olá, bom dia. Em que posso ajudar?\n[Cliente]: Minha internet está caindo muito..."
                      }
                      className="min-h-[300px] font-mono text-sm bg-black/50 leading-relaxed"
                      value={transcript}
                ...
                <CardFooter className="bg-white/5 border-t border-white/5 px-6 py-4 flex justify-end">
                  <Button
                    ...
                    disabled={!transcript.trim() || !protocolo.trim()}
          ...
          {isPending && (
            ...
            >
              ...
              <div className="text-center space-y-2">
                <p className="text-primary tracking-[0.2em] uppercase text-sm animate-pulse font-bold">
                  Processando IA
                </p>
                <p className="text-muted-foreground text-sm max-w-xs mx-auto">
                  Analisando sentimento, extraindo métricas e gerando resumo...
                </p>
              </div>
            </motion.div>
          )}
                ...
                <Card className="md:col-span-2">
                  ...
                  <CardContent className="space-y-6">
                    {[
                      ...
                      {
                        label: "Objetividade",
                        value: result.objectivity,
                        color: "bg-amber-500",
                      },
                      {
                        label: "Resolutividade",
                        value: result.resolutiveness,
                        color: "bg-primary",
                      },
                    ].map((metric) => (
